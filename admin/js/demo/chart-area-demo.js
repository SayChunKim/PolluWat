...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointRadius: 5,
      pointBackgroundColor: "rgba(63, 63, 191, 0)",
      pointBorderColor: "rgba(255,255,255,0.8)",
      pointHoverRadius: 5,
      pointHoverBackgroundColor: "rgba(2,117,216,0)",
      pointHitRadius: 50,
      pointBorderWidth: 2,
    ...
    label: "Timestamp",
      ...
      pointRadius: 5,
      pointBackgroundColor: "rgba(63, 191, 63, 0)",
      pointBorderColor: "rgba(255,255,255,0.8)",
      pointHoverRadius: 5,
      pointHoverBackgroundColor: "rgba(2,193,66,0)",
      pointHitRadius: 50,
      pointBorderWidth: 2,
    ...
    label: "Timestamp",
      ...
      pointRadius: 5,
      pointBackgroundColor: "rgba(127, 63, 191, 0)",
      pointBorderColor: "rgba(255,255,255,0.8)",
      pointHoverRadius: 5,
      pointHoverBackgroundColor: "rgba(2,191,63,0)",
      pointHitRadius: 50,
      pointBorderWidth: 2,
